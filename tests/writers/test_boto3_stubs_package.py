...
class TestBoto3StubsPackage:
    ...
    def test_write_master_package(
        ...
        assert write_boto3_stubs_package(package_mock, output_path_mock) == [output_path_mock] * 10
        ...
        assert write_boto3_stubs_package(package_mock, output_path_mock) == [output_path_mock] * 11
