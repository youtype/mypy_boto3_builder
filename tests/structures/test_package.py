...
class TestPackage:
    def test_init(self) -> None:
        ...
        assert package.get_local_doc_link(ServiceNameCatalog.s3) == "https://youtype.github.io/boto3_stubs_docs/mypy_boto3_s3/"
        ...
        assert package.get_service_pypi_link(ServiceNameCatalog.s3) == "https://pypi.org/project/mypy-boto3-s3/"
