...
def create_retry_handler(config: Config, operation_name: Optional[str] = ...) -> AioRetryHandler: ...
def create_checker_from_retry_config(config: Config, operation_name: Optional[str] = ...) -> AioMaxAttemptsDecorator: ...
