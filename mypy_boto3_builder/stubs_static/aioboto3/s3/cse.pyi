...
class AsymmetricCryptoContext(CryptoContext):
    ...
    def __init__(self, public_key: Optional[_RSAPublicKey] = ..., private_key: Optional[_RSAPrivateKey] = ..., loop: Optional[asyncio.AbstractEventLoop] = ...) -> None: ...
    async def get_decryption_aes_key(self, key: bytes, material_description: Dict[str, Any]) -> bytes: ...
    async def get_encryption_aes_key(self) -> Tuple[bytes, Dict[str, str], str]: ...
    @staticmethod
...
class KMSCryptoContext(CryptoContext):
    ...
    def __init__(self, keyid: Optional[str] = ..., kms_client_args: Optional[dict] = ..., authenticated_encryption: bool = ...) -> None: ...
    async def setup(self) -> None: ...
    async def close(self) -> None: ...
    async def get_decryption_aes_key(self, key: bytes, material_description: Dict[str, Any]) -> bytes: ...
    async def get_encryption_aes_key(self) -> Tuple[bytes, Dict[str, str], str]: ...
...
class MockKMSCryptoContext(KMSCryptoContext):
    ...
    authenticated_encryption: Incomplete
    def __init__(self, aes_key: bytes, material_description: dict, encrypted_key: bytes, authenticated_encryption: bool = ...) -> None: ...
    async def setup(self) -> None: ...
    async def close(self) -> None: ...
    async def get_decryption_aes_key(self, key: bytes, material_description: Dict[str, Any]) -> bytes: ...
    async def get_encryption_aes_key(self) -> Tuple[bytes, Dict[str, str], str]: ...
...
class S3CSE:
    ...
    async def put_object(self, Body: Union[bytes, IO], Bucket: str, Key: str, Metadata: Dict = ..., **kwargs): ...
