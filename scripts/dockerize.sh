...
docker tag mypy_boto3_builder docker.pkg.github.com/vemel/mypy_boto3_builder/mypy_boto3_builder:${VERSION}
docker login docker.pkg.github.com --username vemel -p ${GITHUB_TOKEN}
docker push docker.pkg.github.com/vemel/mypy_boto3_builder/mypy_boto3_builder:${VERSION}
